...
#cp -r /afs/cern.ch/work/c/cherepan/T3M/Tools/master/CMSSW_9_4_4/src/genproductions/bin/MadGraph5_aMCatNLO/DY0Jets/* .
...
#mv process/madevent/Events/${runlabel}/events.lhe.gz cmsgrid_final_1.lhe.gz
#gzip -d cmsgrid_final_1.lhe.g
...
#cp -r process/madevent/Events  /afs/cern.ch/work/c/cherepan/T3M/Tools/master/CMSSW_9_4_4/src/genproductions/bin/MadGraph5_aMCatNLO/DY0Jets/process/madevent/Events
